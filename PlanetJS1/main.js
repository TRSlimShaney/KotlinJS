if (typeof kotlin === 'undefined') {
  ...
  Model.prototype.moveViewUp = function () {
    return this.updateViewDiff_vux9f0$(-1, 0);
  };
  Model.prototype.moveViewDown = function () {
    return this.updateViewDiff_vux9f0$(1, 0);
  };
  Model.prototype.moveViewLeft = function () {
    return this.updateViewDiff_vux9f0$(0, -1);
  };
  Model.prototype.moveViewRight = function () {
    return this.updateViewDiff_vux9f0$(0, 1);
  };
  Model.prototype.updateViewDiff_vux9f0$ = function (diffRow, diffCol) {
  ...
  Model.prototype.jumpTo_vux9f0$ = function (row, col) {
    var selectRow = 5;
    var selectCol = 5;
  ...
  Model.prototype.moveUp_qt1dr2$ = function (who, row, col) {
    return this.moveDiff_0(who, row, col, -1, 0);
  };
  Model.prototype.moveDown_qt1dr2$ = function (who, row, col) {
    return this.moveDiff_0(who, row, col, 1, 0);
  };
  Model.prototype.moveLeft_qt1dr2$ = function (who, row, col) {
    return this.moveDiff_0(who, row, col, 0, -1);
  };
  Model.prototype.moveRight_qt1dr2$ = function (who, row, col) {
    return this.moveDiff_0(who, row, col, 0, 1);
  };
  ...
  Model.prototype.buildPFactory_vux9f0$ = function (row, col) {
    var location = new Location(-1, -1);
    var factory = new PFactory(location);
    return this.build_0(row, col, factory);
  };
  Model.prototype.createPBuilder_vux9f0$ = function (row, col) {
    var location = new Location(row, col);
    var pbuilder = new PBuilder(location);
    return this.create_0(location, pbuilder);
  };
  Model.prototype.createPWorker_vux9f0$ = function (row, col) {
    var location = new Location(row, col);
    var pworker = new PWorker(location);
  ...
  Model.prototype.build_0 = function (row, col, tile) {
    ...
    if (!this.moveLeft_qt1dr2$(builder.owner, builder.loc.row, builder.loc.col)) {
      if (!this.moveDown_qt1dr2$(builder.owner, builder.loc.row, builder.loc.col)) {
        if (!this.moveRight_qt1dr2$(builder.owner, builder.loc.row, builder.loc.col)) {
          if (!this.moveUp_qt1dr2$(builder.owner, builder.loc.row, builder.loc.col)) {
            return false;
          }}}}this.playerData_0.subResource_qt1dr2$(tile.minCost, tile.gasCost, tile.nrgCost);
  ...
  Model.prototype.getPNG_vux9f0$ = function (row, col) {
  ...
  Model.prototype.processEnemyMoves = function () {
    var tmp$, tmp$_0;
  ...
  Model.prototype.processPlayerMoves = function () {
    var tmp$, tmp$_0;
    var newList = ArrayList_init();
  ...
  Model.prototype.processPlayerBuildQueue = function () {
    var tmp$, tmp$_0;
    var newList = ArrayList_init();
  ...
  Model.prototype.processPlayerCreationQueue = function () {
    var tmp$, tmp$_0;
    var newList = ArrayList_init();
  ...
  Model.prototype.processPlayerGatherQueue = function () {
    var tmp$, tmp$_0;
    var newList = ArrayList_init();
  ...
  Model.prototype.issueCommandsAt_qt1dr2$ = function (row, col, command) {
    var tile = this.buffer_0.tiles.get_za3lpa$(row).get_za3lpa$(col);
    var location = tile.loc;
    if (Kotlin.isType(tile, PBuilder)) {
      if (command === 0) {
        if (this.buildPFactory_vux9f0$(location.row, location.col)) {
      ...
      if (command === 0) {
        if (this.createPBuilder_vux9f0$(location.row, location.col)) {
          return 'PBuilder creation in progress';
        }}if (command === 1) {
        if (this.createPWorker_vux9f0$(location.row, location.col)) {
  ...
  function PlanetJ1(height, width, size, diff) {
    this.height_0 = height;
    this.width_0 = width;
    this.size_0 = size;
    this.diff_0 = diff;
    this.model_0 = new Model(this.width_0, this.height_0, this.diff_0);
    this.enemyTurn_0 = false;
    this.gameWon_0 = 0;
    this.time_0 = L1000;
    setInterval(mainLogic, 50);
    setInterval(backgroundLogic, 950);
    setInterval(enemyTurnTimer, 950);
  }
  PlanetJ1.prototype.getTheModel = function () {
    return this.model_0;
  };
  PlanetJ1.prototype.mainLogic = function () {
    while (this.gameWon_0 === 0) {
      this.model_0.processPlayerMoves();
      if (this.enemyTurn_0) {
        this.model_0.processEnemyMoves();
        this.enemyTurn_0 = false;
      }}
    if (this.gameWon_0 === 1) {
      println('You won!!');
    } else if (this.gameWon_0 === 2) {
      println('You lost, too bad!');
    }};
  PlanetJ1.prototype.backgroundLogic = function () {
    while (true) {
      this.model_0.processPlayerWaits();
      this.model_0.processPlayerBuildQueue();
      this.model_0.processPlayerCreationQueue();
      this.model_0.processPlayerGatherQueue();
      this.model_0.processDeadUnits();
      this.model_0.processDeadBuildings();
    }
  };
  PlanetJ1.prototype.enemyTurnTimer = function () {
    while (true) {
      this.enemyTurn_0 = true;
    }
  };
  PlanetJ1.$metadata$ = {
    kind: Kind_CLASS,
